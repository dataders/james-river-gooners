...
export function usePreferences() {
  return usePreferencesStore(
    useShallow((s) => ({
      ...
      baselineExcludedGroups: s.baselineExcludedGroups,
      baselineExcludedCategories: s.baselineExcludedCategories,
      ...
      userLat: s.userLat,
      userLng: s.userLng,
      userLocationLabel: s.userLocationLabel,
      maxDistanceMiles: s.maxDistanceMiles,
      hasComp: s.hasComp,
      ...
      showAll: s.showAll,
      showOnly: s.showOnly,
      setBaselineExcludedGroups: s.setBaselineExcludedGroups,
      setBaselineExcludedCategories: s.setBaselineExcludedCategories,
      toggleBaselineGroup: s.toggleBaselineGroup,
      toggleBaselineCategory: s.toggleBaselineCategory,
      addBaselineGroup: s.addBaselineGroup,
      addBaselineCategory: s.addBaselineCategory,
      removeBaselineGroup: s.removeBaselineGroup,
      removeBaselineCategory: s.removeBaselineCategory,
      ...
      setMaxDistanceMiles: s.setMaxDistanceMiles,
