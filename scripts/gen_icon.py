"""Generate apple-touch-icon.png from inline SVG — Arsenal cannon + Richmond VA flag."""
import cairosvg, pathlib, textwrap

# Richmond VA flag: blue field, gold fringed seal with classical figure
# Arsenal: red/white cannon pointing right
# Combined: split-field shield — Arsenal red left half / Richmond blue right half
# centered gold cannon bridging both halves
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 180" width="180" height="180">
  ...
  <g clip-path="url(#round)">
    ...
    <!-- Arsenal — cannon body (centred, slightly left of middle) -->
    <!-- Barrel -->
...
out = pathlib.Path(__file__).parent.parent / "public" / "apple-touch-icon.png"
cairosvg.svg2png(bytestring=SVG.encode(), write_to=str(out), output_width=180, output_height=180)
print(f"Written {out}")
