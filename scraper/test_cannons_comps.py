...
class ShapeMatchTest(unittest.TestCase):
    ...
    def test_handles_missing_price(self):
        m = cannons_comps.shape_match({"item_id": "x", "comp_item_id": "c", "similarity": 0.5})
...
class BuildCompsTest(unittest.TestCase):
    def _rows(self):
        ...
        return [
            {"item_id": "chair", "comp_item_id": "c2", "similarity": 0.95, "title": "Pine Chair", "sold_price": 30},
            {"item_id": "chair", "comp_item_id": "c3", "similarity": 0.82, "title": "Oak Chair", "sold_price": 45},
            {"item_id": "vase", "comp_item_id": "v9", "similarity": 0.88, "title": "Glass Vase", "sold_price": 50},
        ]
    ...
    def test_groups_by_item_and_writes_to_supabase(self):
        ...
        with mock.patch.object(cannons_comps, "read_manifest", return_value=[{"safeId": "act"}]), \
             ...
             mock.patch("supabase_cannons_comps.write_auction_comps", side_effect=fake_write):
    ...
    def test_dry_run_does_not_write(self):
        with mock.patch.object(cannons_comps, "read_manifest", return_value=[{"safeId": "act"}]), \
            ...
            summary = cannons_comps.build_comps(
                supabase_url="https://x.supabase.co", supabase_key="secret", dry_run=True
            )
    ...
    def test_noop_without_supabase_key(self):
        with mock.patch.object(cannons_comps, "read_manifest", return_value=[{"safeId": "act"}]), \
            ...
            summary = cannons_comps.build_comps(supabase_url="https://x.supabase.co", supabase_key=None)
